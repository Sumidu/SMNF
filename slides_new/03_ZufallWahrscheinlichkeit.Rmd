...
x_large <- sample(1:6, 40, replace=TRUE)  
sample <- rep(  1:4, 10)
...
#set.seed(1000)
x_large <- sample(1:6, 10000, replace=TRUE)
...
- Kurtosis $\gamma$ *= `r results$kurtosis`* - schwach flachgipflig
