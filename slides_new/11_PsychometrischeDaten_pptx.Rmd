...
```{r echo=T, eval=FALSE, fig.height=5}
 lik <- df_lik %>% likert()
plot(lik, type = "bar")
```
...
## Faktoren-Analyse: Was passiert da eigentlich?
...
## Faktorenanalyse durchführen: Vorraussetzungen prüfen
...
## Faktorenanalyse durchführen: Eigenwerte
...
## Faktorenanalyse durchführen: Korrelationen der Faktoren
...
## Faktorenanalyse durchführen: Ladungen der Items auf Faktoren
...
## Faktorenanalyse durchführen: Screeplot
...
## Rotationen: Was passiert da eigentlich?
Rotation der Hauptachsen zur Reduktion der Streuung in der Nebenachse
![](figs/skalen/dimrotation.gif)
