...
---
# Covarianz beschreibt einen Zusammenhang
...
- Korrelation (rechnet die Streuung als Standardabweichung wieder raus)
...
--
```{r correlations, echo=FALSE, out.width="75%"}
...
apastats2::describe.r(res)
```

Es gibt keinen signifikanten Zusammenhang zwischen Körpergröße und Schuhgröße (`r apastats2::describe.r(res)`).
