...
library(forecast)
library(EnvStats)
if (!requireNamespace("gghighlight", quietly=TRUE)) { gghighlight <- function(...) NULL } else { library(gghighlight) }
library(jmv)
```
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Daten)
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Globaler Mittelwert)
```{r, echo=F, fig.height=6}
p +
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum User 3)
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R1 Teil 1)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R1 Teil 2)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R1 komplett)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 1,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R2 Teil 1)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 4,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R2 Teil 2)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 6,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R3 Teil 1)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 7,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R3 Teil 2)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 8,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Residuum R3 komplett)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 9,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (SS_T)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value == 9,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Gruppenmittelwerte)
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Within R_w1)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value < 4,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (Within alle Gruppen)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  gghighlight(value > 0,
              label_key = user,
...
## Beispiel — Whatsapp per Stunde nach Handytyp (SS_w)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  geom_line(
    data = data.frame(x = c(0.6, 1.4), y = c(2.0, 2.0)),
...
## Beispiel — Whatsapp per Stunde nach Handytyp (SS_b und df)
```{r, echo=F, warning=FALSE, fig.height=6}
p +
  geom_line(
    data = data.frame(x = c(0.6, 1.4), y = c(2.0, 2.0)),
